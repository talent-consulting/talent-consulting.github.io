...
When you join talent you will be part of a fast paced, hands on team developing many aspects of government department systems and public facing services
...
Generally it will be a very informal pairing excercise where we can start to see how the developer works, how they think and how they attack a problem.
...
1. A development environment, as you will be asked to solve a problem or issue or develop something from scratch
2. A [teams](https://www.microsoft.com/en-gb/microsoft-teams/group-chat-software) account that we can conduct the interview over should this not be an office based interview.
3. Access to some whiteboarding tools, which will be advised prior to the interview, draw.io, miro are good candidates
